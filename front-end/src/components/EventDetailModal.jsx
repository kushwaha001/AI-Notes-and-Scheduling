          ...
          {ev && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 24px", marginBottom: "20px" }}>
                ...
                <Field label="Time" value={ev.event_time ? (String(ev.event_time).slice(0, 5) + (ev.event_end_time ? ` - ${String(ev.event_end_time).slice(0, 5)}` : "")) : ""} />
                    ...
                    return (
                      <div key={i} style={{ marginBottom: i < extractions.length - 1 ? "16px" : 0 }}>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px 24px" }}>
                          ...
                          <Field label="Time"       value={ex.event_time ? (String(ex.event_time).slice(0, 5) + (ex.event_end_time ? ` - ${String(ex.event_end_time).slice(0, 5)}` : "")) : ""} />
